export const caseStudies = [
  ...
  {
    slug: 'locus',
    tag: 'AI · Organizational Memory',
    company: 'Founder & CEO · AI PM Bootcamp',
    period: '2026',
    title: 'Locus AI: The Memory Layer for Intelligent Work',
    ...
    voc: {
      ...
      hypotheses: [
        { id: 'H1', label: 'Pain is real and frequent', result: 'confirmed', detail: '13 confirmed · 8 challenged · 4 open, the strongest signal of the five' },
    ...
    approach: {
      heading: 'From decision-capture insight to a two-part memory system',
      steps: [
        {
          num: '01',
        ...
        },
        {
          ...
          body: 'Ruled out anything that required teams to change behavior, like manually logging decisions. Locus AI connects via OAuth to Slack, Gmail, and Notion as a read-only listener (no exports, no new workflows), so it starts delivering value from day one without any manual data entry.',
        },
        {
          num: '03',
          title: 'Designed 40+ screens in Figma, then shipped MVP 01',
          body: 'Designed the full product surface, marketing site, onboarding, Memory Explorer, Team Pulse, and Loci, before scoping engineering. MVP 01 is now live across Slack, Gmail, and Notion, running in controlled early-access pilots with 25 users answering: what is relevant, and where did it come from?',
        },
        {
          num: '04',
    ...
    gallery: [
      ...
      { src: '/locus/locus-search-results.png', alt: 'Locus AI search results', title: 'Search results', caption: 'Every answer links back to its original Slack thread or Notion doc, part of the Memory → Citation → View Original trust flow.' },
      { src: '/locus/locus-decision-log.png', alt: 'Locus AI decision log table', title: 'Early decision log', caption: 'An early design iteration for structured memory browsing, since evolved into Memory Explorer.' },
      { src: '/locus/locus-pulse.png', alt: 'Locus AI weekly Pulse digest', title: 'Team Pulse', caption: 'The digest surfacing organizational context and activity that shipped live in MVP 01.' },
    ],
    results: {
