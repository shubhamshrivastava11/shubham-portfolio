...
const projects = [
  ...
  },
  {
    ...
    hook: "J&J's invoice processing ran on decade-old SAP infrastructure: siloed across 5 global regions, manual at scale, and accumulating compliance risk. I led a global SAP S/4HANA → AWS modernization and shipped JAIDA, an enterprise AI platform built on LLMs, RAG, and NLP, cutting invoice extraction errors from 12% to under 2% and delivering 38% faster Accounts Payable processing.",
    scope: '$75M+ portfolio across 6 enterprise AI initiatives · GTS & GFS orgs · 5 regions (NA, LATAM, EMEA, APAC & more) · Engineering, Finance, Legal & Compliance cross-functional · MedTech regulatory context.',
    ...
    metrics: [
      ...
      { value: '38%',   label: 'Faster AP processing' },
      { value: '400+',  label: 'Analyst hrs freed/mo' },
    ],
    tags: ['LLM', 'RAG', 'NLP', 'AWS', 'Microservices', 'PII Compliance'],
...
const timeline = [
  ...
  { type: 'work', period: 'Oct 2025 – Present', role: 'Product Manager II',
    org: 'Johnson & Johnson', location: 'New Jersey, United States', domain: 'MedTech · Enterprise AI', accent: '#7C3AED', brand: 'jnj',
    keyResult: { value: '$75M+', label: 'Product portfolio managed' },
    bullets: [
      'Lead product strategy, roadmap, and execution across 6 enterprise AI and digital transformation initiatives, managing a $75M+ portfolio spanning Global Technology Solutions (GTS) and Global Financial Services (GFS) across North America, LATAM, EMEA, and APAC',
      'Led a global SAP S/4HANA → AWS modernization delivering $2.4M+ annual savings and 38% faster Accounts Payable processing, modernizing enterprise payment platforms across five regions',
      'Own JAIDA, an enterprise AI platform built on LLMs, RAG, and NLP, reclaiming 400+ analyst hours/month while cutting invoice extraction errors from 12% to <2% through enterprise AI guardrails',
      'Defined product vision, strategy, and OKRs for enterprise platforms including IRIS, improving supplier onboarding by 25% through customer discovery and data-driven prioritization',
    ]},
          ...
          <div className="flex flex-col-reverse gap-10 md:flex-row md:items-center md:gap-16">
            ...
            <div className="flex-1">
              ...
              <motion.p {...up(0.1)} style={{ fontSize: '0.9375rem', color: C.muted, maxWidth: '480px', marginBottom: '18px', lineHeight: 1.75 }}>
                I ship AI-native products in regulated domains and build 0→1 bets that find product-market fit. From founding Locus AI and HeyFurnish from scratch to leading a $75M+ AI portfolio at J&J, I lead with discovery, move fast with data, and own outcomes end-to-end.
              </motion.p>
